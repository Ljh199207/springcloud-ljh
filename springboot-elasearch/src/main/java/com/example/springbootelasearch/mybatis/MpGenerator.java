...
public class MpGenerator {
    ...
    private final static String[] table = new String[]{"sec_report"};
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://192.168.215.23:3306/qwgas?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=CTT&allowMultiQueries=true");
